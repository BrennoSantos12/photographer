...
<template>
  <main class="min-h-screen bg-black">
    <div class="flex flex-col md:flex-row justify-between p-6 md:p-10 gap-6">
      <h1
    ...
    <div class="flex justify-center md:justify-start gap-6 md:gap-10 px-6 md:px-10 mt-8 p-10">
      <div class="bg-white h-16 w-16 md:h-20 md:w-20 rounded-full"></div>
      <div class="bg-white h-16 w-16 md:h-20 md:w-20 rounded-full"></div>
      <div class="bg-white h-16 w-16 md:h-20 md:w-20 rounded-full"></div>
    </div>
  </main>
